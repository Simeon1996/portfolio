...
*Building an agent in production and hit a failure mode not covered here? Drop it in the comments — the edge cases are where the real architecture lessons live.*
