...
![A vertical ladder diagram with four rungs. Bottom rung labeled "Gemma 2B / Phi-3 Mini — default start." Second rung labeled "Mistral 7B / Llama 3 8B — graduate when small model fails eval." Third rung labeled "Llama 3 70B / DeepSeek-R1 — graduate when mid-tier fails." Top rung labeled "GPT-5 / Claude Opus — last resort, justify the cost." An arrow on the right side of the ladder reads "only climb when eval forces you."](/images/blog/small-model-graduation-ladder.svg)
